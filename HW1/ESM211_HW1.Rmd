...
Therefore, the grizzly bear population declined from 1959-1968 at an average rate of -0.7636 bears per year.
...
There is a strong negative correlation between grizzly bear population and year (*r* = `r round(grizzly1959_1968_cor$estimate,2)`, t(`r grizzly1959_1968_cor$parameter`) = `r round(grizzly1959_1968_cor$statistic,2)`, p = 0.02, $\alpha$ = 0.05). 

Therefore, the grizzly bear population continued to decline from 1969 to 1978 at an average rate of -0.7576 bears per year. The rate of decline (-0.7576 bears per year) was slightly slower than the period prior to the dump closures (-0.7636 bears per year).
...
There is a strong positive correlation between grizzly bear population and year (*r* = `r round(grizzly1978_1997_cor$estimate,2)`, t(`r grizzly1978_1997_cor$parameter`) = `r round(grizzly1978_1997_cor$statistic,2)`, p < 0.001, $\alpha$ = 0.05). 

Therefore, the grizzly bear population increased from 1978 to 1997 at an average rate of 3.07 bears per year.
...
During the 10 years prior to the dump closures, the grizzly bear population in Yellowstone National Park was declining at a statistically significant rate. During the 10 years following the first dump closures in 1968, the grizzly bear population continued to significantly decline, although at a slightly slower rate than before the dump closures. However, after 1978, 10 years after dump closures were implemented, the grizzly bear population has significantly increased. There could be a few reasons for these trends in grizzly bear population abundance.
